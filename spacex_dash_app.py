...
def scatter(entered_site, payload):
    ...
    if entered_site == 'ALL':
        fig = px.scatter(filtered_df, x='Payload Mass (kg)', y ='Booster Version Category', title='Success Count on Payload Mass for All Sites')
        return fig
    else:
        fig = px.scatter(filtered_df[filtered_df['Launch Site'] == entered_site], x='Payload Mass (kg)', y ='class', color = 'Booster Version Category', title='Success Count on Payload Mass for Site')
# Run the app
